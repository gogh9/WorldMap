...
export const COUNTRY_ALIASES = {
  ...
  "AE": ["아랍에미리트", "아랍에미레이트"],
  "AF": ["아프가니스탄"],
  "AG": ["안티구아 바부다", "안티구아바부다", "앤티가 바부다", "앤티가바부다", "앤티카 바부다", "앤티카바부다"],
  "AL": ["알바니아"],
  "AM": ["아르메니아"],
  "AO": ["앙골라"],
  "AR": ["아르헨티나"],
  ...
  "CF": ["중앙 아프리카", "중앙아프리카", "중앙아프리카 공화국", "중앙아프리카공화국"],
  "CG": ["콩고"],
  "CH": ["스위스"],
  "CI": ["코트디부아르"],
  "CL": ["칠레"],
  ...
  "ME": ["몬테네그로"],
  "MG": ["마다가스카르"],
  "MH": ["마샬 군도", "마샬군도", "마셜 제도", "마샬제도", "마셜 군도", "마셜군도", "마셜 제도", "마셜제도"],
  "MK": ["마케도니아", "북마케도니아"],
  "ML": ["말리"],
  "MM": ["미안마", "미얀마", "버마"],
  "MN": ["몽골", "몽고"],
  ...
  "RW": ["르완다"],
  "SA": ["사우디아라비아"],
  "SB": ["솔로몬 아일랜드", "솔로몬아일랜드", "솔로몬 제도", "솔로몬제도", "솔로몬 군도", "솔로몬군도"],
  "SC": ["세이셸"],
  "SD": ["수단"],
  "SE": ["스웨덴"],
  "SG": ["싱가포르", "싱가폴"],
  ...
  "SR": ["수리남"],
  "SS": ["남수단"],
  "ST": ["상토메프린시페", "상투메 프린시페", "상투메프린시페"],
  "SV": ["엘살바도르"],
  "SY": ["시리아"],
  "SZ": ["스와질란드", "에스와티니", "에스와티니 왕국", "에스와니티왕국"],
  "TD": ["차드"],
  "TG": ["토고"],
  "TH": ["태국", "타이"],
  "TJ": ["타지키스탄"],
